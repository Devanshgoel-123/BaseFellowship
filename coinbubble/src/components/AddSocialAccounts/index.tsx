...
export default function AddSocialAccounts({ onBack }: LinkSocialAccountsProps) {
  ...
  const handleCardClick = (cardType: string) => {
    ...
    if (cardType === 'zora') {
      console.log('Adding Zora account...');
      ...
      <div className="max-w-sm mx-auto">
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          <p className="text-black/70 text-center leading-relaxed">
            Adding your social accounts<br />
        ...
        <div className="relative grid grid-cols-2 gap-4">
          ...
          >
            <div className="relative flex flex-col items-center justify-center h-full">
              ...
              <span className="absolute text-black font-medium text-base text-center top-[80%]">Add Zora</span>
            </div>
          </div>
          ...
          >
            <div className="relative flex flex-col items-center justify-center h-full">
              ...
              <div className="absolute top-[80%] text-center mb-4">
                <span className="block text-black font-medium text-base mb-[-4px]">@bubblebanger</span>
