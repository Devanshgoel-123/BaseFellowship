  ...
  return (
    <div className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="relative w-full max-w-[450px] h-full flex flex-col items-center justify-center mx-auto px-4">
        ...
        <div className="absolute w-[200px] h-[100px] sm:w-[250px] sm:h-[130px] md:w-[300px] md:h-[160px] lg:w-[378px] lg:h-[202.73px] left-1/2 -translate-x-1/2 top-[180px] sm:top-[220px] md:top-[260px] lg:top-[324px]">
          <img
            src={NAME_IMAGE}
            alt="Bubble Shooter"
