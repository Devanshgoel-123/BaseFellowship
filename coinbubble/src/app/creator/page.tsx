            ...
            <div className="w-full max-w-xs">
              ...
              <div className="w-full bg-white/10 backdrop-blur-md rounded-2xl p-6 border-2 border-white/20">
                <p className="text-blue-100 text-center mb-6">
                  Connect your Zora collection to start earning
                </p>
                ...
                <div className="mt-8 pt-6 border-t border-white/10">
                  ...
                  <ol className="space-y-3 text-sm text-blue-100">
                    <li className="flex items-start">
                      <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-blue-500 text-white text-xs font-bold mr-2 flex-shrink-0">
                        1
                      </span>
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Be redirected to Zora to complete the connection
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-blue-500 text-white text-xs font-bold mr-2 flex-shrink-0">
                      ...
                      <span>
                        Start earning rewards when players use your collection
                        in-game
                      </span>
                    </li>
                  </ol>
